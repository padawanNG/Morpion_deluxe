            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant={getPlayerBadgeVariant(gameState.currentPlayer)}>
                ...
                {gameState.gameMode === 'solo' && (
                  <span className="ml-1">
                    {gameState.isBot ? '(Bot)' : '(You)'}
                  </span>
                )}
              </Badge>
            </div>
            
            {gameState.isBot && gameState.gameMode === 'solo' && (
              <div className="text-xs text-gray-600 dark:text-gray-400 bg-yellow-50 dark:bg-yellow-900/50 p-2 rounded">
                Bot is thinking...
              </div>
            )}
          </div>
